  ...
  Redmine::WikiFormatting::Macros.register do
    ...
    macro :import_gantt, :parse_args => false do |obj, args, text|
      ...
      if theme && !theme.empty? 
        content = content + "t = document.createElement(\"link\"); t.href =\"/plugin_assets/bryt_wiki_extension/skins/dhtmlxgantt_#{theme}.css\"; t.media=\"all\"; t.rel=\"stylesheet\"; head.appendChild(t); "
      else
...
.none{
  display:none;
      ...
      html = '<div id="gantt" style="width:100%;height:1000px;"></div>'
